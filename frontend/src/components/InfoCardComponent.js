...
class InfoCardComponent extends React.Component {
  ...
  render(){
    ...
    if (this.props.searchResult.properties && this.props.searchResult.properties.length > 0){
      var ownedPropertiesText = <p className="subheader-text">Owned Properties:</p>
    }  
